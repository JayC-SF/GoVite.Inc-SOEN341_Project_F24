                        ...
                        <div className="-space-y-px rounded-md shadow-sm">
                            <div>
                                ...
                                <input
                                    ...
                                    type="email"
                                    required
                                    className="relative block w-full appearance-none rounded-t-md border border-gray-300 px-3 py-2 placeholder:text-gray-400 focus:border-[#ca3448] focus:outline-none focus:ring-[#ca3448] sm:text-sm"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    type="password"
                                    required
                                    className="relative block w-full appearance-none rounded-b-md border border-gray-300 px-3 py-2 placeholder:text-gray-400 focus:border-[#ca3448] focus:outline-none focus:ring-[#ca3448] sm:text-sm"
